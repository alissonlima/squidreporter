...
class Relatorio1_IndexController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
		...
		$form = new Relatorio1_Form_Filtro();
		echo $form;
                ...
                if ($this->getRequest()->isPost()) 
		{
			if ($form->isValid($request->getPost())) 
			{
				...
				$filtro = new Relatorio1_Model_FiltroData();
                               # echo $filtro->Build($date_month, $date_year);
				echo $filtro->Build($date_begin, $date_end);
			}
		}
